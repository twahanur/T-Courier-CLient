...
const OrdersTable = ({ allOrdersList, handleChange, handleUpdate }) => {
    const { name, Date, price, status, _id } = allOrdersList;
    let className;
    switch (status) {
        case 'Pending':
    ...
    return (
        ...
        <>
            <ul className="OListLi">
                ...
                <li><h4 className="OnlyResponsive">Product Name</h4>{Date}</li>
                <li><h4 className="OnlyResponsive">Payment Using</h4>{price}</li>
